...
import { transformCombinedScalarsSeries } from "metabase/visualizations/visualizations/Scalar/transformDataset";
...
export class Scalar extends Component {
  ...
  render() {
    ...
    if (rawSeries.length > 1) {
      const { barSeries, settings } = transformCombinedScalarsSeries(rawSeries);
      return (
        <BarChart {...this.props} rawSeries={barSeries} settings={settings} />
      );
    }
